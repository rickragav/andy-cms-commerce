...
<script src="{{ asset('assets/dashboard/js/scripts/config.lazyload.js') }}?v={{ system_version() }}" defer></script>

<script src="{{ asset('assets/dashboard/js/scripts/palette.js') }}" defer></script>
<script src="{{ asset('assets/dashboard/js/scripts/ui-load.js') }}?v={{ system_version() }}" defer></script>
